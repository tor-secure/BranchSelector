...
const PrivacyPolicy = () => {
  return (
    <article className=" max-w-screen-xl mx-auto my-4">
      <h1 className="text-3xl ">Privacy Policy</h1>
      <div className="">
        Privacy Policy <strong>Hello</strong> Last updated: February 04, 2024
        ...
        Company", "We", "Us" or "Our" in this Agreement) refers to TorSecure,
        #9, Second Floor, Manasa towers. Cookies are small files that are placed
        ...
        its many uses. Country refers to: Karnataka, India Device means any
        ...
        Website refers to Branch Selector, accessible from
        https://www.branchselector.com You means the individual accessing or
        ...
        Usage Data Usage Data Usage Data is collected automatically when using
        ...
        unique device identifiers and other diagnostic data. We may also collect
        information that Your browser sends whenever You visit our Service or
        when You access the Service by or through a mobile device. Tracking
        ...
        information. Delete Your Personal Data You have the right to delete or
        request that We assist in deleting the Personal Data that We have
        ...
        basis to do so. Disclosure of Your Personal Data Business Transactions
        ...
        Privacy Policy, You can contact us: By email: info@branchselector.com
      </div>
    </article>
  );
};
