...
const AddCreditSliderTabs = () => {
 ...
 return (
  <div className="font-poppins min-h-screen mt-20 items-center mx-5 lg:mr-24 flex flex-col">
    <div className="flex relative px-1 border rounded-md w-full max-w-md mx-auto">
      ...
      <button
        className={`flex-1 py-4 px-2 text-center relative z-10 transition-colors duration-300 text-sm ${
          activeTab === 'buyCredits' ? 'text-white font-bold' : 'text-black font-bold'
        }`}
      ...
      <button
        className={` flex-1 py-4 px-2 text-center relative z-10 transition-colors duration-300 text-sm ${
          activeTab === 'useVoucher' ? 'text-white font-bold' : 'text-black font-bold'
        }`}
