                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Dont have an account? <a onClick={onClickHandler} className="font-medium text-indigo-600 hover:text-indigo-500 cursor-pointer">Sign up</a></p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <a onClick={forgotPasswordHandler} className="text-sm font-medium text-indigo-600 hover:text-indigo-500 cursor-pointer justify-center">Forgot password?</a>
                        <div>
