const PrivacyPage = () =>{
    ...
    <div className="max-w-4xl mx-auto p-8">
      ...
      <ul className="list-disc list-inside mt-2">
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to TorSecure, #9, Second Floor, Manasa towers.</li>
        ...
        <li><strong>Website</strong> refers to Branch Selector, accessible from <a href="https://www.branchselector.com" className="text-blue-600 underline">https://www.branchselector.com</a></li>
      ...
      <h4 className="text-lg font-bold mt-2">Tracking Technologies and Cookies</h4>
      ...
      <h5 className="text-md font-bold mt-2">Cookies or Browser Cookies</h5>
      ...
      <h5 className="text-md font-bold mt-2">Web Beacons</h5>
      <p className="mt-2">Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</p>
      
      <h5 className="text-md font-bold mt-2">Cookies can be "Persistent" or "Session" Cookies</h5>
      <p className="mt-2">Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on TermsFeed website article.</p>
      
      <p className="mt-2">We use both Session and Persistent Cookies for the purposes set out below:</p>
      
      <h5 className="text-md font-bold mt-2">Necessary / Essential Cookies</h5>
      <ul className="list-disc list-inside mt-2">
      ...
      <h5 className="text-md font-bold mt-2">Cookies Policy / Notice Acceptance Cookies</h5>
      <ul className="list-disc list-inside mt-2">
      ...
      <h5 className="text-md font-bold mt-2">Functionality Cookies</h5>
      <ul className="list-disc list-inside mt-2">
        <li><strong>Type:</strong> Persistent Cookies</li>
        <li><strong>Administered by:</strong> Us</li>
      ...
      <h2 className="text-2xl font-bold mt-8">Retention of Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold mt-8">Transfer of Your Personal Data</h2>
      ...
      <h2 className="text-2xl font-bold mt-8">Delete Your Personal Data</h2>
      
      <p className="mt-2">You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.</p>
      ...
      <h2 className="text-2xl font-bold mt-8">Disclosure of Your Personal Data</h2>
      
      <h3 className="text-xl font-bold mt-4">Business Transactions</h3>
      ...
      <h3 className="text-xl font-bold mt-4">Law enforcement</h3>
      ...
      <h3 className="text-xl font-bold mt-4">Other legal requirements</h3>
      ...
      <h2 className="text-2xl font-bold mt-8">Security of Your Personal Data</h2>
      
      <p className="mt-2">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
