...
const PaymentConfirmationPage = () => {
    ...
    const {planDetail, appointmentDetail, paymentDetail} = location.state
    ...
    return(
        <div className="flex flex-col h-full max-w-3xl min-h-lvh lg:mx-auto md:mx-auto sm:m-2 p-8 font-poppins text-center border-2 rounded-lg">
            ...
            <span className="mt-12 text-sm text-wrap break-words">For queries, contact:<br/> educatorananth@gmail.com<br/>+91 8951511111</span>
